...
$.ajax({
	type:"get"
	,url:"http://localhost:8080/supermarket/data/get_commodity_info.php"
	,async:true
	,data:{
		id:pro_id
	}
	...
	,complete:function(){
		...
		$.ajax({
			type:"get"
			,url:"http://localhost:8080/supermarket/data/get_commodity_evluate.php"
			,async:true
			,data:{
				commodity_id:pro_id
			}
...
function getData (pro_id,start) {
	$.ajax({
		type:"get"
		,url:"http://localhost:8080/supermarket/data/get_commodity_evluate_info.php"
		,async:true
		,data:{
			'commodity_id':pro_id,
			'start':start
...
$('#add_cart').click(function(){
	if (username) {
		$.ajax({
			type:"get"
			,url:"http://localhost:8080/supermarket/data/my_commodity_car.php"
			,async:true
			,data:{
				'user_phone':username,
				'commodity_id':pro_id,
